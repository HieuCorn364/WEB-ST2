				...
				<div class="top-cart-content">
					<ul class="scroller" style="height: 250px">
						<li><a href="shop-item.html"><img
							...
							<span class="cart-content-count">x 1</span> <strong><a
			...
			<ul>
					...
					<ul class="dropdown-menu">
						<li class="dropdown-submenu"><a href="shop-product-list.html">Hi
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="shop-product-list.html">Second Level Link</a>
								</li>
								<li><a href="shop-product-list.html">Second Level Link</a>
								</li>
								<li class="dropdown-submenu"><a class="dropdown-toggle"
									...
									<ul class="dropdown-menu">
										<li><a href="shop-product-list.html">Third Level Link</a>
										</li>
										<li><a href="shop-product-list.html">Third Level Link</a>
										</li>
										<li><a href="shop-product-list.html">Third Level Link</a>
							...
							<div class="header-navigation-content">
								<div class="row">
									<div class="col-md-4 header-navigation-col">
										<h4>Footwear</h4>
										<ul>
											<li><a href="shop-product-list.html">Astro Trainers</a>
											</li>
											...
											<li><a href="shop-product-list.html">Football Boots</a>
											</li>
											<li><a href="shop-product-list.html">Golf Shoes</a></li>
											<li><a href="shop-product-list.html">Hi Tops</a></li>
											<li><a href="shop-product-list.html">Indoor
													and Court Trainers</a></li>
										</ul>
									</div>
									<div class="col-md-4 header-navigation-col">
										<h4>Clothing</h4>
									...
									<div class="col-md-4 header-navigation-col">
										...
										<ul>
											...
											<li><a href="shop-product-list.html">Gloves,
													Hats and Scarves</a></li>
										</ul>
									...
									<div class="col-md-12 nav-brands">
										<ul>
											<li><a href="shop-product-list.html"><img
													...
													src="../../assets/frontend/pages/img/brands/esprit.jpg" /></a>
											</li>
											<li><a href="shop-product-list.html"><img
													title="gap" alt="gap"
													src="../../assets/frontend/pages/img/brands/gap.jpg" /></a>
											</li>
											<li><a href="shop-product-list.html"><img
													title="next" alt="next"
													src="../../assets/frontend/pages/img/brands/next.jpg" /></a>
											</li>
											<li><a href="shop-product-list.html"><img
													title="puma" alt="puma"
													src="../../assets/frontend/pages/img/brands/puma.jpg" /></a>
											</li>
											<li><a href="shop-product-list.html"><img
													title="zara" alt="zara"
													src="../../assets/frontend/pages/img/brands/zara.jpg" /></a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-3 col-sm-4 col-xs-6">
										<div class="product-item">
											...
											<a href="#" class="btn btn-default add2cart">Add
												to cart</a>
										</div>
									</div>
									<div class="col-md-3 col-sm-4 col-xs-6">
				...
				<li class="dropdown active"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li><a href="shop-shopping-cart-null.html">Shopping
								Cart (Null Cart)</a></li>
						...
						<li><a href="shop-goods-compare.html">Product Comparison</a>
						</li>
